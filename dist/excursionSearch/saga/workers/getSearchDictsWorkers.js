...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(getSearchOperatorsWorker),
  _marked2 = /*#__PURE__*/_regeneratorRuntime().mark(getSearchTransportsWorker),
  _marked3 = /*#__PURE__*/_regeneratorRuntime().mark(getSearchCategoriesWorker),
  _marked4 = /*#__PURE__*/_regeneratorRuntime().mark(getSearchPricesWorker);
function getSearchOperatorsWorker() {
  var langAsQuery, operators;
  return _regeneratorRuntime().wrap(function getSearchOperatorsWorker$(_context) {
...
function getSearchTransportsWorker() {
  var langAsQuery, transports;
  return _regeneratorRuntime().wrap(function getSearchTransportsWorker$(_context2) {
...
function getSearchCategoriesWorker() {
  var langAsQuery, categories;
  return _regeneratorRuntime().wrap(function getSearchCategoriesWorker$(_context3) {
...
function getSearchPricesWorker() {
  var langAsQuery, prices;
  return _regeneratorRuntime().wrap(function getSearchPricesWorker$(_context4) {
