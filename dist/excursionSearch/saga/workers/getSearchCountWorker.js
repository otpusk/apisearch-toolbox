...
function getSearchCountWorker(_ref) {
  ...
  return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var langAsQuery, query, formattedQuery, excursionsCount;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          _context.prev = 7;
          _context.next = 10;
          return (0, _effects.call)(_excursionApi.getSearchCount, _objectSpread(_objectSpread({}, langAsQuery), formattedQuery));
        case 10:
