...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(getOfferSaga),
    _marked2 = /*#__PURE__*/_regeneratorRuntime().mark(bootstrapOfferSaga);
...
function getOfferSaga(offerID) {
  var fresh,
      ...
      offer,
      _args = arguments;
  return _regeneratorRuntime().wrap(function getOfferSaga$(_context) {
    while (1) {
...
function bootstrapOfferSaga(_ref) {
  ...
  return _regeneratorRuntime().wrap(function bootstrapOfferSaga$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 9:
          _context2.next = 11;
          return (0, _effects.put)(_actions.offersActions.setOfferStatus(offer.id, _constants.ALIVE_OFFER_STATUS));
        ...
        case 19:
          _context2.next = 21;
          return (0, _effects.put)(_actions.offersActions.getOfferFail(_context2.t0, offerId));
