...
function getOperatorsWorker(_ref) {
  ...
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var countryId, _payload$options, options, _yield$select, _yield$select2, token, lang, operators, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 5:
          ...
          _t = _context.v;
          _context.n = 6;
          return (0, _effects.put)(_actions.operatorsActions.getOperatorsFail(_t));
        case 6:
          _context.n = 7;
          return (0, _effects.put)(_actions.operatorsActions.setUiFlag([countryId, 'error'], true));
        case 7:
          _context.n = 8;
          return (0, _effects.put)(_actions.operatorsActions.setUiFlag([countryId, 'message'], _t.message));
        case 8:
          _context.p = 8;
          _context.n = 9;
