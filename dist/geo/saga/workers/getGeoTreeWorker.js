...
function getGeoTreeWorker(_ref) {
  var _ref$payload = _ref.payload,
    ...
    withPrice = _ref$payload.withPrice,
    _ref$payload$depth = _ref$payload.depth,
    depth = _ref$payload$depth === void 0 ? 'city' : _ref$payload$depth;
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var token, lang, options, geoTree, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          lang = _context.v;
          options = _objectSpread(_objectSpread({}, token), {}, {
            lang: lang,
            depth: depth,
            id: countryId
          }, withPrice ? {
          ...
          _context.p = 3;
          _context.n = 4;
          return (0, _effects.call)(_jsonApi.getToursGeoTree, options);
        case 4:
          geoTree = _context.v;
          _context.n = 5;
          return (0, _effects.put)(_actions.geoActions.getGeoTreeSuccess(countryId, geoTree));
        case 5:
          _context.n = 7;
          break;
        case 6:
          ...
          _t = _context.v;
          _context.n = 7;
          return (0, _effects.put)(_actions.geoActions.getGeoTreeFail(_t));
        case 7:
          return _context.a(2);
      }
    }, _callee, null, [[3, 6]]);
