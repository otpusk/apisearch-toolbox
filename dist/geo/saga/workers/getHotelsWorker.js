...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(getHotelsWorker);

function getHotelsWorker(_ref) {
  var payload, countryId, withPrice, services, rating, methodVersion, token, lang, hotels, storeKey;
  return _regeneratorRuntime().wrap(function getHotelsWorker$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          storeKey = (0, _helpers.generateHotelKey)(countryId, rating, services);
          _context.next = 15;
          return (0, _effects.put)(_actions.geoActions.getHotelsSuccess(countryId, storeKey, hotels));
