...
function getCountriesWorker(_ref) {
  ...
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var _payload$options, options, methodVersion, _yield$select, token, lang, countries, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _payload$options = payload.options, options = _payload$options === void 0 ? {
            'with': 'price'
          } : _payload$options, methodVersion = payload.methodVersion;
          _context.p = 1;
          _context.n = 2;
        ...
        case 2:
          ...
          return (0, _effects.call)(_jsonApi.getToursCountries, token, _objectSpread({
            lang: lang
          }, options), methodVersion);
        case 3:
          countries = _context.v;
          _context.n = 4;
        ...
        case 5:
          ...
          _t = _context.v;
          _context.n = 6;
          return (0, _effects.put)(_actions.geoActions.getCountriesFail(_t));
        case 6:
          return _context.a(2);
      }
    }, _callee, null, [[1, 5]]);
