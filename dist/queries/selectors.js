...
var getQuery = exports.getQuery = (0, _reselect.createSelector)(domain, function (_, _ref) {
  var queryID = _ref.queryID;
  return queryID;
}, function (queriesMap, queryID) {
  return queriesMap.get(queryID);
});
var getQueryParam = exports.getQueryParam = (0, _reselect.createSelector)(getQuery, function (_, _ref2) {
