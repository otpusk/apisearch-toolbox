...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(parseQueryParam);
...
function parseQueryParam(paramName, rawValue, queryId) {
  ...
  return _regeneratorRuntime().wrap(function parseQueryParam$(_context) {
...
function parseQueryStringWorker(_ref) {
  ...
  return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var baseQuery, queryParams, _iterator, _step, _loop, resultQuery;
