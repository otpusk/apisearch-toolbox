...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } // Core
// Instruments
/**
 * Parse binary string
 *
...
var datesParser = exports.datesParser = function datesParser(value) {
  if (value.includes(encodeURIComponent(_constants.RANGE_DATE_TAG))) {
    var _value$split = value.split(encodeURIComponent(_constants.RANGE_DATE_TAG)),
      _value$split2 = _slicedToArray(_value$split, 2),
      mediana = _value$split2[0],
      range = _value$split2[1];
    return (0, _immutable.Map)(_defineProperty({
...
var geoParser = exports.geoParser = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(value, _ref4) {
    var token, location;
