...
function getHotelsMarkersWorker(_ref) {
  var _ref$payload = _ref.payload,
    ...
    cityId = _ref$payload.cityId,
    center = _ref$payload.center,
    radius = _ref$payload.radius;
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var token, markers, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 4:
          ...
          _t = _context.v;
          _context.n = 5;
          return (0, _effects.put)(_actions.hotelsActions.getHotelsMarkersFail(_t));
        case 5:
          return _context.a(2);
      }
    }, _callee, null, [[0, 4]]);
