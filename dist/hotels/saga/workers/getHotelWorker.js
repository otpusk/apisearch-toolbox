...
function getHotelWorker(_ref) {
  var _ref$payload = _ref.payload,
    hotelId = _ref$payload.hotelId,
    customLang = _ref$payload.customLang;
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var _yield$select, token, lang, _yield$call, hotel, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 4:
          ...
          _t = _context.v;
          _context.n = 5;
          return (0, _effects.put)(_actions.hotelsActions.getHotelFail(_t));
        case 5:
          return _context.a(2);
      }
    }, _callee, null, [[0, 4]]);
