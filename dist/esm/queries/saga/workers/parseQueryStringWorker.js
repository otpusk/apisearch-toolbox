...
import { binaryParser, datesParser, rangeParser, createImmutableArrayParser, createImmutableNumbersArrayParser } from '../../parsers';
...
export function parseQueryStringWorker(_ref) {
  let {
    payload: {
      queryString,
      queryId
