...
export function getDescriptionsByOperatorWorker(_ref) {
  let {
    payload: {
      operatorID,
  ...
  return function* () {
    ...
    try {
      const descriptions = yield call(getToursHotelDescriptionsByOperator, token, {
        lang,
        subHotelID,
        subOperatorName,
        operatorId: operatorID
      });
      yield put(hotelsActions.getDescriptionsByOperatorSuccess(operatorID, descriptions));
    } catch (error) {
