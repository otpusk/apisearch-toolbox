...
var extractLabels = function extractLabels(services) {
  return R.call(R.pipe(R.omit(['byCountries', 'chains']), R.toPairs, R.map(function (_ref5) {
...
function getServicesWorker(_ref7) {
  var _ref7$payload = _ref7.payload,
    ...
    _ref7$payload$options = _ref7$payload.options,
    options = _ref7$payload$options === void 0 ? {} : _ref7$payload$options;
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var withIcons, fresh, _yield$select, token, lang, services, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          withIcons = options.withIcons, fresh = options.fresh;
          _context.p = 1;
          _context.n = 2;
        ...
        case 2:
          ...
          _context.n = 3;
          return (0, _effects.call)(_jsonApi.getToursServices, token, countryId, lang, withIcons, fresh);
        case 3:
          services = _context.v;
          _context.n = 4;
        ...
        case 6:
          ...
          _t = _context.v;
          _context.n = 7;
          return (0, _effects.put)(_actions.servicesActions.getServicesFail(_t));
        case 7:
          return _context.a(2);
      }
    }, _callee, null, [[1, 6]]);
