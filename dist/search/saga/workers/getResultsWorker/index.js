...
function getResultsWorker(_ref) {
  ...
  return /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var query, lang, token, otpsukQuery, activePage, memory, _yield$call, finished, hotels, offers, country, operators, _total, meta, prices, _memory$getValues2, usedPrices, totalValue, ignoreOperators, _memory$getValues3, total, _memory$getValues4, _usedPrices;
