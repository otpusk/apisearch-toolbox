...
function silentSearchWorker(_ref) {
  ...
  return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var query, memory, selectedOperators, _memory$getValues, hotelsHub, offersHub, unusedPrices, stablePrices, prices, nextPrices, hotelsFromStore, hotelsToStore, offersToStore;
