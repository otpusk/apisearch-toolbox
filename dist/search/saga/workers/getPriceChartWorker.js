...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(getPriceChartWorker);
...
function getPriceChartWorker(_ref) {
  var _ref$payload, queryId, duration, methodVersion, token, query, params, chart;

  return _regeneratorRuntime().wrap(function getPriceChartWorker$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _ref$payload = _ref.payload, queryId = _ref$payload.queryId, duration = _ref$payload.duration, methodVersion = _ref$payload.methodVersion;
          _context.next = 3;
        ...
        case 3:
          ...
          return (0, _effects.select)(function (state) {
            return (0, _selectors2.getQuery)(state, {
              queryID: queryId
            });
          });
        ...
        case 6:
          ...
          _context.next = 11;
          return (0, _effects.call)(_jsonApi.getToursGraph, token, params, methodVersion);
