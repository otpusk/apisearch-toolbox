...
function getPriceChartWorker(_ref) {
  var _ref$payload = _ref.payload,
    ...
    duration = _ref$payload.duration,
    methodVersion = _ref$payload.methodVersion;
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var token, query, params, chart, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 6:
          ...
          console.error(_t);
          _context.n = 7;
          return (0, _effects.put)(_actions.searchActions.getPriceChartFail(_t));
        case 7:
          return _context.a(2);
      }
    }, _callee, null, [[3, 6]]);
