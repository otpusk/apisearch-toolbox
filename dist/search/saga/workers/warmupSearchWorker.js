...
function warmupSearchWorker(_ref) {
  ...
  return /*#__PURE__*/_regenerator().m(function _callee() {
    var token, lang, query, otpQuery, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          query = _context.v;
          otpQuery = (0, _fn.convertToOtpQuery)(query.set(_fn.QUERY_PARAMS.LANGUAGE, lang));
          _context.p = 4;
          _context.n = 5;
          return (0, _effects.call)(_jsonApi.getToursStartSearch, token, otpQuery);
        case 5:
          _context.n = 7;
          break;
        case 6:
